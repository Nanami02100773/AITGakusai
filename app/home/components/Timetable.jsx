      ...
      <div className="box">
        <table>
          ...
          <tbody>
            ...
            <tr><td>17:00 〜 18:00</td><td className="divider-space"></td><td>アンケート回収</td></tr>
            <tr><td>18:00 〜 19:00</td><td className="divider-space"></td><td>後片付け</td></tr>
            <tr><td>19:00 〜 20:00</td><td className="divider-space"></td><td>スタッフ打ち上げ</td></tr>
            <tr><td>20:00 〜</td><td className="divider-space"></td><td>会場完全撤収</td></tr>
          </tbody>
        </table>
      </div>
    </section>
