...
const cardData = [
...

  {
    ...
    subdesc1:
      "私たちは、大学公式イメージキャラクター「鉄人28号」を学生の手で実現するプロジェクトです。現在は23代目の機体を開発し、最先端のAI技術である強化学習を用いた歩行制御に取り組んでいます。また、地域連携活動を通して、子どもたちにものづくりの楽しさを伝えています。ロボットやAIに興味のある方はもちろん、どなたでも大歓迎です。ぜひお気軽にお越しください！",
  ...
  {
    group:
      "2026 Ene-1 SUZUKA Challenge, 2026 Ene-1 MOTEGI GP KV-40への挑戦",
  ...
  {
    group: "ETロボコン2026参戦プロジェクト",

    subdesc1:
      "チームAITは、ETロボコンに挑戦するロボット開発チームです。自律走行ロボットの制御・プログラミング・モデル設計に取り組み、仲間と協力しながら課題解決力を磨き、競技会での入賞を目指しています。大学祭では実機や競技コース、活動成果を展示し、組込みシステム開発の魅力を紹介します。",
