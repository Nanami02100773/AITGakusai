...
import "./LaughMusicInfo.css"; // ← ★ここ重要
    ...
    <section className="LaughMusic-performer-section">
      <div className="LaughMusic-scroll-area">
        {artists.map((artist, index) => (
          <div className="LaughMusic-profile-box" key={index}>
            <div className="LaughMusic-profile">
              <div className="LaughMusic-photo">
                <img
                  src={artist.image}
                  alt={artist.name}
                  style={{
            ...
            {artist.sns && (
              <div className="LaughMusic-sns-wrapper">
                <p className="LaughMusic-sns-title">公式SNS</p>
